...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { codigo_do_pais: @cidade.codigo_do_pais, nome: @cidade.nome } }, as: :json
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { codigo_do_pais: @cidade.codigo_do_pais, nome: @cidade.nome } }, as: :json
    assert_response 200
  end
